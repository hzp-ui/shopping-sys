...
- Name: dashboard.spec.js >> 控制台/仪表盘 >> 统计卡片包含增长/下降标识
- Location: tests\admin\dashboard.spec.js:37:3
...
Locator: locator('.anticon-arrow-up').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.anticon-arrow-up').first()
