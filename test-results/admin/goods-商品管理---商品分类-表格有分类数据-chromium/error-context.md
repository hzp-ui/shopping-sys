...
- Name: goods.spec.js >> 商品管理 - 商品分类 >> 表格有分类数据
- Location: tests\admin\goods.spec.js:106:3
...
Locator: locator('.ant-table-tbody tr').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.ant-table-tbody tr').first()
