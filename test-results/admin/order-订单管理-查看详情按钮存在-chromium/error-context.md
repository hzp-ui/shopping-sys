...
- Name: order.spec.js >> 订单管理 >> 查看详情按钮存在
- Location: tests\admin\order.spec.js:66:3
...
Locator: getByRole('button', { name: '详情' }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: '详情' }).first()
