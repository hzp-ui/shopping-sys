...
- Name: goods.spec.js >> 商品管理 - 商品列表 >> 点击删除按钮显示确认弹窗
- Location: tests\admin\goods.spec.js:72:3
...
Call log:
  - waiting for getByRole('button', { name: '删除' }).first()
      ...
      - menu [ref=e7]:
        - menuitem "dashboard 控制台" [ref=e8] [cursor=pointer]:
          - img "dashboard" [ref=e9]:
            - img [ref=e10]
          - generic [ref=e12]: 控制台
        - menuitem "shopping 商品管理" [expanded] [ref=e13] [cursor=pointer]:
          - img "shopping" [ref=e14]:
            - img [ref=e15]
          - generic [ref=e17]: 商品管理
        - menu [ref=e18]:
          - menuitem "商品列表" [ref=e19] [cursor=pointer]:
            - generic [ref=e20]: 商品列表
          - menuitem "商品分类" [ref=e21] [cursor=pointer]:
            - generic [ref=e22]: 商品分类
        - menuitem "unordered-list 订单管理" [ref=e23] [cursor=pointer]:
          - img "unordered-list" [ref=e24]:
            - img [ref=e25]
          - generic [ref=e27]: 订单管理
        - menuitem "user 用户管理" [ref=e28] [cursor=pointer]:
          - img "user" [ref=e29]:
            - img [ref=e30]
          - generic [ref=e32]: 用户管理
  - generic [ref=e33]:
    - banner [ref=e34]:
      - img "menu-fold" [ref=e35] [cursor=pointer]:
        - img [ref=e36]
