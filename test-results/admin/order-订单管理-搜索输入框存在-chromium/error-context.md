...
- Name: order.spec.js >> 订单管理 >> 搜索输入框存在
- Location: tests\admin\order.spec.js:20:3
...
Locator: locator('input[placeholder="请输入订单号"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('input[placeholder="请输入订单号"]')
