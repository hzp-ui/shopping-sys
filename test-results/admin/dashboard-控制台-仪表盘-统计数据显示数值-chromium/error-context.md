...
- Name: dashboard.spec.js >> 控制台/仪表盘 >> 统计数据显示数值
- Location: tests\admin\dashboard.spec.js:21:3
...
Locator:  locator('.ant-statistic-content-value')
Expected: 4
Received: 0
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('.ant-statistic-content-value')
