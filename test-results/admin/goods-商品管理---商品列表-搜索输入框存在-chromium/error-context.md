...
- Name: goods.spec.js >> 商品管理 - 商品列表 >> 搜索输入框存在
- Location: tests\admin\goods.spec.js:16:3
...
Locator: locator('input[placeholder="请输入商品名称"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('input[placeholder="请输入商品名称"]')
